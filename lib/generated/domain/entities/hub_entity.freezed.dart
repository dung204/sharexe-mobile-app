...
@override
String toString() {
  return 'HubEntity(id: $id, name: $name, address: $address, latitude: $latitude, longitude: $longitude)';
}
...
class _HubEntity extends HubEntity {
  const _HubEntity({required this.id, required this.name, required this.address, required this.latitude, required this.longitude}): super._();
