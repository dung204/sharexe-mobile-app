...
class SplashCubit extends Cubit<SplashState> {
  SplashCubit(this._appPreferences) : super(const SplashState.initial());
  ...
  Future<void> init() async {
    ...
    final isFirstRun = _appPreferences.isFirstRun;
    emit(
      isFirstRun ? const SplashState.firstRun() : const SplashState.completed(),
    );
  }
}
